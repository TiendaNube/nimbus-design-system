...
const mockGenerateGradientId =
  ...
  >;
const mockInjectGradientDefs =
  svgManipulation.injectGradientDefs as jest.MockedFunction<
    typeof svgManipulation.injectGradientDefs
  >;
const mockProcessElement =
  svgManipulation.processElement as jest.MockedFunction<
    typeof svgManipulation.processElement
  >;
const mockCreateSvgGradientDef =
  gradientFactory.createSvgGradientDef as jest.MockedFunction<
    typeof gradientFactory.createSvgGradientDef
  >;
...
describe("gradientProcessor utilities", () => {
  beforeEach(() => {
    ...
    mockCreateSvgGradientDef.mockReturnValue(
      React.createElement("linearGradient", { id: "test-gradient-id" })
    );
  });
  ...
  describe("applyGradientToSvg", () => {
    ...
    it("should process direct SVG elements", () => {
      ...
      const processedSvg = React.createElement(
        "svg",
        {},
        React.createElement("path", { fill: "url(#test-gradient-id)" })
      );
      const finalSvg = React.createElement(
        "svg",
        {},
      ...
      expect(mockCreateSvgGradientDef).toHaveBeenCalledWith(
        "test-gradient-id",
        "linear"
      );
      ...
      expect(mockInjectGradientDefs).toHaveBeenCalledWith(
        processedSvg,
        expect.any(Object)
      );
    ...
    it("should process nested component structures", () => {
      ...
      const MockIconComponent = () =>
        React.createElement("svg", {}, React.createElement(NestedComponent));
