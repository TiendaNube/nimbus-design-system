...
- Adjusted medium button padding from `8px 16px` to `6px 12px` to match design specifications. ([#PR](https://github.com/TiendaNube/nimbus-design-system/pull/PR) by [@usuario](https://github.com/usuario))
