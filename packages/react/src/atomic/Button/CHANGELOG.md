...
- Adjusted medium button padding from `8px 16px` to `6px 12px` to match design specifications. ([#428](https://github.com/TiendaNube/nimbus-design-system/pull/428) by [@usuario](https://github.com/usuario))
