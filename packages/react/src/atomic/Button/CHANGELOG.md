...
- Added `size` property to `Button` component with support for `small` and `medium` sizes. ([#PR](https://github.com/TiendaNube/nimbus-design-system/pull/PR) by [@usuario](https://github.com/usuario))
