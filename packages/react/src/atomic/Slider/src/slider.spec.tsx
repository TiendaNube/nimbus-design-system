...
describe("GIVEN <Slider /> in single value mode", () => {
  ...
  describe("WHEN showLabels is true", () => {
    it("THEN should render labels container", () => {
      makeSingleSut({ showLabels: true });
      expect(screen.getByTestId("slider-labels")).toBeInTheDocument();
    });

    it("THEN should display default min and max labels", () => {
      makeSingleSut({ showLabels: true, min: 0, max: 100 });
    ...
    it("THEN should display custom labels when provided", () => {
      makeSingleSut({
        showLabels: true,
        minLabel: "Low",
        maxLabel: "High",
    ...
    it("THEN should not render labels when showLabels is false", () => {
      makeSingleSut({ showLabels: false });
      expect(screen.queryByTestId("slider-labels")).not.toBeInTheDocument();
    });
  });
});

describe("GIVEN <Slider.Range /> with labels", () => {
  describe("WHEN showLabels is true", () => {
    it("THEN should render labels container", () => {
      makeSut({ showLabels: true });
      expect(screen.getByTestId("slider-labels")).toBeInTheDocument();
    });

    it("THEN should display default min and max labels", () => {
      makeSut({ showLabels: true, min: 0, max: 100 });
      expect(screen.getByTestId("slider-min-label")).toHaveTextContent("0");
      expect(screen.getByTestId("slider-max-label")).toHaveTextContent("100");
    });
    ...
    it("THEN should display custom labels when provided", () => {
      ...
      expect(screen.getByTestId("slider-max-label")).toHaveTextContent("End");
    });

    it("THEN should not render labels when showLabels is false", () => {
      makeSut({ showLabels: false });
      expect(screen.queryByTestId("slider-labels")).not.toBeInTheDocument();
    });
  });
});
