...
- Added `neutral.background` color properties from sprinkle sppiner. ([#31](https://github.com/TiendaNube/nimbus-design-system/pull/31) by [@juniorconquista](https://github.com/juniorconquista))
- Added `currentColor` color properties from sprinkle text. ([#31](https://github.com/TiendaNube/nimbus-design-system/pull/31) by [@juniorconquista](https://github.com/juniorconquista))

### 💡 Others

- Removed background colors from primary, success, warning, and danger scales for basic and dark themes. ([#31](https://github.com/TiendaNube/nimbus-design-system/pull/31) by [@juniorconquista](https://github.com/juniorconquista))
- Removed `primary.background`, `danger.background`, `success.background`, `waring.background` properties from sprinkle colors. ([#31](https://github.com/TiendaNube/nimbus-design-system/pull/31) by [@juniorconquista](https://github.com/juniorconquista))
- Removed `primary.background`, `danger.background`, `success.background`, `waring.background` color properties from sprinkle icon. ([#31](https://github.com/TiendaNube/nimbus-design-system/pull/31) by [@juniorconquista](https://github.com/juniorconquista))
- Removed `primary.background`, `danger.background`, `success.background`, `waring.background` color properties from sprinkle text. ([#31](https://github.com/TiendaNube/nimbus-design-system/pull/31) by [@juniorconquista](https://github.com/juniorconquista))
