...
- `Toast`: Align progress variant background with Figma by using `neutral.textHigh`. ([#329](https://github.com/TiendaNube/nimbus-design-system/pull/329) by [@joacotornello](https://github.com/joacotornello))
