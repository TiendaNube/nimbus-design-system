...
- `Button`: Fixed hover effect to the AI secondary appearance using boxShadows. ([#372](https://github.com/TiendaNube/nimbus-design-system/pull/371) by [@jffs](https://github.com/jffs))
